...
class TestPanel(wx.Panel):
    ...
    def __init__(self, parent):
        ...
        # Actually load the Url that in self.current variable
    ...
    def OnOpenButton(self, event):
        dlg = wx.TextEntryDialog(self, "Open Location","Enter a full URL or local path",self.current, wx.OK|wx.CANCEL)
        dlg.CentreOnParent()
